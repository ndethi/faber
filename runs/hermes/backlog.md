...
| BG-022 | User Request (Phase 2) | **Faber Launch Splash (faber-splash skill)** — New repo `faber-www` or fresh branch. Built with #1's design system. Splash page: (a) what Faber is, (b) what shipped (rohaki-mvp + splash), (c) loop diagram + live PR/deploy receipts. CTA → Intent Wizard. One iteration. | HIGH | **in_progress** |
