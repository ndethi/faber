...
|| BG-020 | PR #59 (framework) | **Add domain-suggest skill** — SKILL.md + scripts/ + evals/ to generate production domain candidates per FRAMEWORK.md §13 | MEDIUM | in_progress |
