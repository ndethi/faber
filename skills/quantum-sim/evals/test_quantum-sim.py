#!/usr/bin/env python3
"""
Eval for the quantum-sim skill.
...
def test_skill_md_exists() -> None:
    ...
    skill_md = Path("skills/quantum-sim/SKILL.md")
    ...
    assert "quantum-sim" in content, "SKILL.md must mention skill name"
    print("✓ SKILL.md exists with required fields")


def test_script_exists_and_executable() -> None:
    """Test that main script exists and is executable."""
    script = Path("skills/quantum-sim/scripts/quantum-sim.py")
...
def test_script_help() -> None:
    ...
    result = subprocess.run(
        [sys.executable, "skills/quantum-sim/scripts/quantum-sim.py"],
        capture_output=True,
        text=True,
    )
...
def test_determinism() -> None:
    ...
    with tempfile.TemporaryDirectory() as tmpdir1, tempfile.TemporaryDirectory() as tmpdir2:
        ...
        result1 = subprocess.run([
            sys.executable,
            "skills/quantum-sim/scripts/quantum-sim.py",
            "--input", input_json,
            "--output-dir", tmpdir1
